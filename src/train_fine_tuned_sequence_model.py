...
def train_fine_tuned_sequence_model(data,
    ...
    x_train, x_val, word_index = vectorize_data.sequence_vectorize(
        train_texts, val_texts, '../models/tweet_weather_sepcnn_fine_tuned_vectorizer.json')
    ...
    # Save the model.
    model.save_weights('../models/sequence_model_with_pre_trained_embedding.h5')
    ...
    model.load_weights('../models/sequence_model_with_pre_trained_embedding.h5')
    ...
    # Save model.
    model.save('../models/tweet_weather_sepcnn_fine_tuned_model.h5')
